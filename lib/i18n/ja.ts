...
export const ja: Translations = {
  ...
  overview: {
    ...
    cards: [
      { title: 'キーボードショートカット', desc: 'Ctrl+Enter, Ctrl+Shift+F など、コーディングを速くするショートカット。' },
  ...
  shortcutsPage: {
    ...
    sections: [
      { title: '▶ 実行', color: 'text-indigo-400', items: [
        ...
        { keys: ['Ctrl', 'Shift', 'F'], desc: 'コードを自動フォーマット' },
      ]},
  ...
  shortcutsModal: {
    ...
    sections: [
      { title: '実行', items: [{ keys: ['Ctrl', 'Enter'], desc: 'コンパイル&実行 (テストケースタブなら全テスト)' }, { keys: ['Ctrl', 'Shift', 'F'], desc: 'コードをフォーマット' }] },
  ...
  settings: {
    ...
    toggles: {
      ...
      smoothCaret:             { label: 'スムーズカーソル',          desc: 'カーソル移動にアニメーションを追加' },
    },
    fontSize:   'フォントサイズ',
    tabSize:    'タブサイズ',
    runTimeout: '実行タイムアウト',
